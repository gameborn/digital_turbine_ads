...
public abstract class Hilt_AdDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdDetailsFragment() {
    super();
  }

  Hilt_AdDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((AdDetailsFragment_GeneratedInjector) this.generatedComponent()).injectAdDetailsFragment(UnsafeCasts.<AdDetailsFragment>unsafeCast(this));
  }
